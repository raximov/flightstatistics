...
from .views import FlightStatistics1,FlightStatistics2, FlightStatisticsAPIView3, FlightStatisticsSQL4, FlightStatisticsAPIView5
urlpatterns = [
    ...
    path('stats5/', FlightStatisticsAPIView5.as_view())
]
